          ...
          child: Material(
            ...
            child: AnimatedContainer(
              ...
              child: _AppMenu(
                ...
                menuAboutTitle: widget.menuAboutTitle,
                menuLeadingAvatarLabel: widget.menuLeadingAvatarLabel,
                menuLeadingAvatarImage: widget.menuLeadingAvatarImage,
      ...
      children: <Widget>[
        ListTile(
          ...
          leading: CircleAvatar(
            ...
            // ),
            //'images/icon.png'
            child: Image.asset(widget.menuLeadingAvatarImage), //, height: 96, width: 96),
          ),
                      ...
                      TextButton(
                        ...
                        child: Column(
                          children: <Widget>[
                            ...
                            Text(widget.menuAboutTitle, style: textTheme.labelSmall),
                          ],
                        ),
                      ),
