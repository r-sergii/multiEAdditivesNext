...
class AppData {
  ...
  static const String icon = 'images/eadditives_lite.png';
  ...
  static final Uri privacyPolicyUri = Uri(
    scheme: 'http',
    host: 'multiapps.inf.ua',
    path: 'privat/flutter/multieadditives/privacy_policy.htm',
  );
  static final Uri storeAndroidUri = Uri(
      ...
      queryParameters: {'id': 'ua.multiapps.meadditiveslite'});
  ...
  static final Uri storeWindowsUri = Uri(
    ...
    // path: 'store/apps/9NBLGGH50VT8?ocid=badge',
    path: 'store/apps/9NPVXQ27MSSQ?ocid=badge',
  );
